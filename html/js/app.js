...
function handleDragDrop() {
    $(".item-drag").draggable({
        ...
        stop: function () {
            ...
            $(this).css("background", "rgba(75, 75, 75, 0.322)");
    ...
    if (fromData !== undefined && fromData.amount >= $toAmount) {
        ...
        if (
            ...
            if (fromData.amount == $toAmount) {
                ...
                var ItemLabel =
                    '<p>' + newData.label + "</p></div>";
                if (newData.name.split("_")[0] == "weapon") {
                    if (!Inventory.IsWeaponBlocked(newData.name)) {
                        ItemLabel =
                            '<div class="item-slot-quality"><div class="item-slot-quality-bar"><p>100</p></div></div><p>' +
                            newData.label +
                            "</p></div>";
                    }
                }
                ...
                $fromInv
                    .find("[data-slot=" + $fromSlot + "]")
                    .html(
                        '<div class="item-slot-img"></div><p>&nbsp;</p></div>'
                    );
                    ...
                    if ($fromSlot < 6 && $fromInv.attr("data-inventory") == "player") {
                        $fromInv
                            ...
                            .html(
                                '<div class="item-slot-key"><p>' +
                                $fromSlot +
                                '</p></div><div class="item-slot-img"></div><p>&nbsp;</p></div>'
                            );
                    } else if (
                        $fromSlot == 21 &&
                        $fromInv.attr("data-inventory") == "player"
                        ...
                        $fromInv
                            .find("[data-slot=" + $fromSlot + "]")
                            .html(
                                '<div class="item-slot-key"><p>6 <i class="fas fa-lock"></i></p></div><div class="item-slot-img"></div><p>&nbsp;</p></div>'
                            );
                    } else {
                        $fromInv
                            .find("[data-slot=" + $fromSlot + "]")
...
function InventoryError($elinv, $elslot) {
    $elinv
        ...
        .css("background", "rgba(156, 21, 21, 0.5)")
    ...
    Inventory.Open = function (data) {
        ...
        for (i = 1; i < 6; i++) {
            $(".player-inventory").append(
                ...
                '"><div class="item-slot-key"><p>' +
                i +
                '</p></div><div class="item-slot-img"></div><p>&nbsp;</p></div></div>'
            );
        }
        for (i = 6; i < data.slots + 1; i++) {
            if (i == 21) {
                $(".player-inventory").append(
                    '<div class="item-slot" data-slot="' +
                    i +
                    '"><div class="item-slot-key"><p>6 <i class="fas fa-lock"></i></p></div><div class="item-slot-img"></div><p>&nbsp;</p></div></div>'
                );
            } else {
                $(".player-inventory").append(
                    '<div class="item-slot" data-slot="' +
                    i +
                    '"><div class="item-slot-img"></div><p>&nbsp;</p></div></div>'
                );
            }
        }
        ...
        if (data.open) {
            ...
            for (i = 1; i < 6; i++) {
                var elem =
                    ...
                    i +
                    '</p></div><div class="z-hotbar-item-slot-img"></div><p>&nbsp;</p></div></div>';
